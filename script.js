// --- IMPORT FUNGSI FIREBASE (SINTAKS BARU V9+) ---
import { initializeApp } from "https://www.gstatic.com/firebasejs/9.6.10/firebase-app.js";
import { getFirestore, collection, addDoc, serverTimestamp, query, orderBy, limit, onSnapshot } from "https://www.gstatic.com/firebasejs/9.6.10/firebase-firestore.js";

// --- KONFIGURASI FIREBASE ---
// Konfigurasi Anda dari Firebase Console
...
// --- FUNGSI INTERAKSI DENGAN FIREBASE (SINTAKS BARU V9+) ---
...
function listenToLeaderboardChanges() {
    ...
    const leaderboardQuery = query(collection(db, "leaderboard"), orderBy("score", "desc"), limit(20));
